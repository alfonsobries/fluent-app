...
assert.strictEqual(M.promptPreview("  Use Mexican Spanish.  "), "Use Mexican Spanish.")
assert.strictEqual(M.promptPreview("x".repeat(80), 20).length, 20)
assert.strictEqual(M.promptPreview(""), "No prompt yet")
